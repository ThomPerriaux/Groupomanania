            ...
            axios
                ...
                .catch((err) => {
                  if(err.response.data.error.errors.pseudo){
                        alert('Pseudo non autorisé ou dejà utilisé, veuillez en choisir un autre 👀')
                  } else if (err.response.data.error.errors.email){
                        alert('Adresse email non autorisée ou dejà utilisée, veuillez en choisir une autre 👀') 
            }})
        }
    }
